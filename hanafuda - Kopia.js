var hanafuda = function () {
	/*
	 * SkÅ‚adniki globalne dla gry
	 */
	...
	function Win(dealt, sets) {
		//this.draw = function (dealt) {
			...
			var title = gamestate === 7 ? "Zwyciê™stwo" : gamestate === 8 ? "Remis" : "Przegrana";
			var subtitle = gamestate === 7 ? "Wygra³‚e¶›" : gamestate === 8 ? "" : "Przeciwnik wygra³‚";
			...
			if (gamestate !== 8) {
				...
				ctx.fillText("£±cznie : " + dealt.mypoints + " pkt", 260, 200);
