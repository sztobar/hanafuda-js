var hanafuda = function () {
	...
	function Win(dealt, sets) {
		//this.draw = function (dealt) {
			...
			var title = gamestate === 7 ? "Zwycięstwo" : gamestate === 8 ? "Remis" : "Przegrana";
			var subtitle = gamestate === 7 ? "Wygrałeś" : gamestate === 8 ? "" : "Przeciwnik wygrał";
		...
		return {
			...
			draw: function () {
				...
				case 0:
					break;
				case 1:
					this.text = "Wybierz kartę z ręki.";
					break;
				case 2:
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	var ophand = new CardContainer(20, 20, false);
	for (i = 0; i < 8; ++i) {
